...
func buildAdfsSamlWsfedTemplate(to, username, password, relyingParty string) (string, error) {
...
func buildAdfsSamlTokenTemplate(token []byte, notBefore, notAfter, relyingParty string) (string, error) {
