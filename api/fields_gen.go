// Code generated by `ggen -ent Fields -item Field -conf -coll -mods Select,Expand,Filter,Top,Skip,OrderBy -helpers Data,Normalized`; DO NOT EDIT.
...
func (fields *Fields) Skip(skipToken string) *Fields {
	fields.modifiers.AddSkip(skipToken)
	return fields
}
